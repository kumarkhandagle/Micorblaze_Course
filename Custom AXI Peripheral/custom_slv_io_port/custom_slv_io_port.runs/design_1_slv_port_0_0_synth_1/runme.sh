...
HD_PWD='C:/Users/labview/custom_slv_io_port/custom_slv_io_port.runs/design_1_slv_port_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_slv_port_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_slv_port_0_0.tcl
