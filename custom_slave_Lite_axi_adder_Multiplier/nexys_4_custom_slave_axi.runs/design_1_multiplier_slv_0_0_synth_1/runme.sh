...
HD_PWD='C:/Users/labview/nexys_4_custom_slave_axi/nexys_4_custom_slave_axi.runs/design_1_multiplier_slv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_multiplier_slv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_multiplier_slv_0_0.tcl
