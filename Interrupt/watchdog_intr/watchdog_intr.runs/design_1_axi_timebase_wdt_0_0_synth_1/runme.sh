...
HD_PWD='C:/Users/labview/watchdog_intr/watchdog_intr.runs/design_1_axi_timebase_wdt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_timebase_wdt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_timebase_wdt_0_0.tcl
